 ...
 */
class Krish_Home_Block_Product extends Mage_Core_Block_Template
{
    ...
    public function getProducts($position)
    {
        //get first products that is selected to show below the banner
        if (is_null($this->_productCollection)) {
            ...
            $collection
                ->addAttributeToFilter('show_in_homepage', array('eq' => $showdesc))
            ...
            $firstProduct = $_product->load($id);
            $this->_productCollection = $firstProduct;
        }
